...
import {Contest, CreateProblemRequest, ProblemTag, TestCase} from "@/apis/type.ts";
	...
	const onFinish = async (values: any) => {
		try {
			...
			const problemData: CreateProblemRequest = {
				...
				tags: values.tags,
				inputs: testCases.map((tc: TestCase) => tc.input),
				outputs: testCases.map((tc: TestCase) => tc.output),
			};
